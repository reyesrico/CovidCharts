    ...
    <footer className="footer">
      <div className="footer__inner">
        ...
        <div className="footer__links">
          ...
          <a className="footer__link footer__link--why" href="https://github.com/reyesrico/CovidCharts/blob/master/README.md" target="_blank" rel="noopener noreferrer">
            <span className="footer__why-badge">?</span>
            About
          </a>
        </div>
